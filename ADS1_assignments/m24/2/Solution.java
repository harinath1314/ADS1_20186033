...
public final class Solution {
    ...
    public static void main(String[] args) {
        ...
        BinarySearchST<String, Student> rbbst = new BinarySearchST<String , Student>();
        for (int i = 0; i < noOfOperations; i++) {
            String[] stud = sc.nextLine().split(",");
            rbbst.put(stud[0], new Student(stud[1], Double.parseDouble(stud[2])));
        ...
        for (int j = 0; j < nOqueries; j++) {
            ...
            for (Student s : rbbst.vals) {
                ...
                break;
            case"LE":
                // for (String s: rbbst.keys(rbbst.min(), rbbst.max())) {
            for (Student s : rbbst.vals) {
